...
Module._initPaths = function() {
  ...
  if (isWindows) {
    ...
    prefixDir = path.resolve(process.execPath, '..', '..');
    var paths = [
      '/usr/lib/nodejs/nodejs-7.9/node_modules',   // version specific - arch dep
      '/usr/share/nodejs/nodejs-7.9/node_modules', // version specific - arch indep
      '/usr/lib/nodejs/node_modules',              // global arch dependent
      '/usr/share/nodejs/node_modules',            // global arch independent
      '/usr/lib/nodejs',                           // legacy
    ]
  }
